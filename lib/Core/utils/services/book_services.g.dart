...
class _ApiService implements ApiService {
  ...
  @override
  Future<AuthorDetails> getAuthorDetails(String authorId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<AuthorDetails>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _value = AuthorDetails.fromJson(_result.data!);
    return _value;
  }
